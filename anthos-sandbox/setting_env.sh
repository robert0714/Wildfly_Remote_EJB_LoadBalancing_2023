...
kubectl apply -f  "$BASE/../cluster-example-server/k8s-yml/ejb-slb-prometheus.yaml"

echo "======================================="
echo "Deploying Client Side"

kubectl apply -f  "$BASE/../cluster-example-client/k8s-yml/ejb-slb-client-prometheus.yaml" 